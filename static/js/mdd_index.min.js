(function (b) {
    var f = {
        init: function () {
            this.landingInit();
           /* this.seckillInit();*/
           /* this.suggestInit(); 暂时没用，精简自己的项目依赖*/
            ...
            var b = new Image, e = a.attr("imgsrc");
            b.onload = function () {
            ...
            var e = Date.now(), d = document.createElement("IFRAME");
            d.src = a;
            ...
            b(".J_banner_slider").each(function () {
                var c = b(this)[0].id, c = new IScroll("#" + c, {
                    scrollX: !0, scrollY: !1, snap: !1,
                    momentum: !1, click: !1, eventPassthrough: !0, preventDefault: !0
                });
                c.pageNum = 0;
            ...
            window.onscroll = function () {
                ...
                0 == b(".rec-prds").length && !0 != b(".rec-prds-wrapper").data("lazyLoad") && b(window).scrollTop() + window.innerHeight > b(".rec-prds-wrapper").offset().top - 150 && (b(".rec-prds-wrapper").data("lazyLoad", !0),
                    a.recPrdsInit())
            }
            ...
            var a = this, c = b("html").css("font-size").replace("px", "");
            window.rec_prds = {pageSize: 4, currentPageNum: 1, maxPageNum: 1, liWidth: 5.25 * c, pageWidth: 21 * c};
            window.recUnlock = !0;
            ...
            window.recUnlock && (window.recUnlock = !1, b.ajax({
                ...
                data: {action: "ad_cpc", page: a, pagesize: c, lastpage: window.rec_last_page},
                dataType: "json",
                success: function (g) {
                    if (0 == g.errorCode) {
            ...
            var a = document.body.scrollTop || document.documentElement.scrollTop, c = b(window).height(),
                e = b(".fixed_box"), d = b(".top")[0];
            a > c ? e.show() : e.hide();
