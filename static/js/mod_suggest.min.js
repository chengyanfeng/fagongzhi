...
Suggest.prototype = {
    initInput: function () {
        ...
        if ("" == a.replace(/(^\s*)|(\s*$)/g, "")) that.getElemByClassName(".search_list")[0].innerHTML = "", that.getElemByClassName(".search_list")[0].style.display = "none"; else {
        ...
        if (null != b && document.all) b.src = a; else {
            var d = document.documentElement.firstChild, c = document.createElement("script");
            c.id = "temp_script";
        ...
        var b = a.match(/\.\S*/),
            d = (a = a.match(/\s\S[\S]*/ig)) ? a.length : 0, c = null;
